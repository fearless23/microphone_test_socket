...
const URLS = {
  prod2: 'http://139.59.74.127:4000',
  prod: 'http://34.83.55.238:4000',
...
class App extends Component {
    ...
    return (
      <div className='App'>
        <div>
          ...
          {this.renderTime()}
          <p>This is an sample text. Which the user will read.</p>
        </div>
  ...
  renderTime() {
    return <span>{(Math.round(this.state.recordingTime / 100) / 10).toFixed(1)}s</span>;
  }
